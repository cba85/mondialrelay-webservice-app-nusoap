<form method="post" action="barcodes.php">
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-footer text-center">
            <button type="submit" class="btn btn-success btn-lg" id="create_expedition"><i class="fa fa-fw fa-check-circle"></i> <?php _e("Get barcodes") ?></button>
        </div>
