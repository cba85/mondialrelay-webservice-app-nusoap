        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <h2 class="text-center"><?php _e("Mondial Relay shipping barcodes"); ?></h2>

                    <p class="lead text-center"><?php _e("Get barcodes of a Mondial Relay shipping with your parameters") ?></p>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <?php if ($_POST) { include('views/barcodes/barcodes-request.php'); } ?>

                <?php require_once 'views/barcodes/barcodes-parameters.php';?>
